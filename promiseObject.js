...
function mapPromises(object) {
  ...
  var resolved = Array.isArray(object) ? [] : {};
  var innerPromises = [];
  var promises = Object.entries(object).map(function () {
    var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(_ref) {
      var _ref3 = (0, _slicedToArray3.default)(_ref, 2),
          key = _ref3[0],
          promise = _ref3[1];

      var _mapPromises, promises, resolved2;

      return _regenerator2.default.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              if (!((typeof promise === 'undefined' ? 'undefined' : (0, _typeof3.default)(promise)) !== 'object' || typeof promise.then !== 'undefined')) {
                _context.next = 4;
                break;
              }
            ...
            case 3:
              return _context.abrupt('return', resolved[key] = _context.sent);

            case 4:
              _mapPromises = mapPromises(promise), promises = _mapPromises.promises, resolved2 = _mapPromises.resolved;
...
module.exports = function () {
  var _ref4 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(object) {
    var _mapPromises2, promises, resolved;

    return _regenerator2.default.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _mapPromises2 = mapPromises(object), promises = _mapPromises2.promises, resolved = _mapPromises2.resolved;
            _context2.next = 3;
